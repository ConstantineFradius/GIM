...
public class Materials {
    ...
    public static Material Fuchsite = new Material(Ref.ID, "fuchsite", 0x7bdbc2, FINE).asDust().mats(b -> b.put(Potassium, 1).put(Aluminium, 2).put(Chromium, 1).put(Silicon, 3));
    ...
    public static Material Tourmaline = new Material(Ref.ID, "tourmaline", 0x030201, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).mats(b -> b.put(Lithium, 1).put(Manganese, 1).put(Magnesium, 2).put(Chromium, 1).put(Vanadium, 1).put(Boron, 5).put(Flourine, 1));
    ...
    public static Material AventurineGroup = new Material(Ref.ID, "aventurine_group", 0x960000, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(YellowAventurine, 1).put(GreyAventurine, 1).put(GreenAventurine, 2).put(BlueAventurine, 1).put(RedAventurine, 1));
    ...
    public static Material RareEarthsA = new Material(Ref.ID, "rare_earth_a", 0x646464, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Lanthanum, 7).put(Neodymium, 7).put(Samarium, 2).put(Cerium, 13).put(Yttrium, 6));
    public static Material RareEarthsB = new Material(Ref.ID, "rare_earths_b", 0xbfbfbf, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Samarium, 3).put(Europium, 1).put(Gadlinium, 1).put(Terbium, 1).put(Dysprosium, 1));
    public static Material RareEarthsC = new Material(Ref.ID, "rare_earths_c", 0xffff1e, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Erbium, 1).put(Thulium, 1).put(Ytterbium, 1).put(Lutetium, 1).put(Hafnium, 1));
    public static Material RareEarths = new Material(Ref.ID, "rare_earths", 0xffffff, METALLIC).asDust(ORE, ORE_SMALL).mats(of(RareEarthsA, 40, RareEarthsB, 8, RareEarthsC, 6));
    ...
    public static Material PreciousMetalsGroup = new Material(Ref.ID, "precious_metals_group", 0xffff1e, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Gold, 1).put(Silver, 4).put(Indium, 3).put(Mercury, 3).put(Copper, 3).put(Cadmium, 2));
    public static Material IronMetalsGroup = new Material(Ref.ID, "iron_metals_group", 0xc8c8fa, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Iron, 10).put(Nickel, 2).put(Cobalt, 1).put(Chrome, 1).put(Vanadium, 1));
    public static Material WorkingMetalsGroup = new Material(Ref.ID, "working_metals_group", 0xff6400, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Zinc, 5).put(Gallium, 1).put(Copper, 4).put(Nickel, 3).put(Cobalt, 2));
    public static Material PrePlatinumTransition = new Material(Ref.ID, "preplatinum_transition", 0xb4b4dc, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Molybdenum, 5).put(Zirconium, 4).put(Niobium, 2).put(Hafnium, 1).put(Tantalum, 2));
    public static Material NuclearGroup = new Material(Ref.ID, "nuclear_group", 0x32f032, METALLIC).asDust(ORE, ORE_SMALL).mats(of(Thorium, 16, Uranium, 10, Uranium235, 1, Plutonium, 1));
    public static Material HeavyMetalsGroup = new Material(Ref.ID, "heavy_metals_group", 0x8c648c, METALLIC).asDust(ORE, ORE_SMALL).mats(b -> b.put(Mercury, 2).put(Bismuth, 5).put(Lead, 10).put(Silver, 2).put(Tin, 4));
    public static Material RubyGroup = new Material(Ref.ID, "ruby_group", 0xff6464, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Ruby, 2).put(PinkSapphire, 4).put(OrangeSapphire, 2).put(YellowSapphire, 2));
    public static Material SapphireGroupA = new Material(Ref.ID, "sapphire_group_a", 0x6464c8, SHINY).asDust(ORE, ORE_SMALL).mats(of(GreenSapphire, 2, BlueSapphire, 10, WhiteSapphire, 4, BlackSapphire, 2));
    public static Material SapphireGroup = new Material(Ref.ID, "sapphire_group", 0x6464c8, SHINY).asDust(ORE, ORE_SMALL).mats(of(SapphireGroupA, 5, RubyGroup, 1, Alumina, 2));
    public static Material BerylGroupA = new Material(Ref.ID, "beryl_group_a", 0xffffff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Emerald, 6).put(Goshenite, 10).put(Morganite, 4).put(Bixbite, 1).put(Heliodor, 3));
    public static Material BerylGroupB = new Material(Ref.ID, "beryl_group_b", 0xfafaed, SHINY).asDust(ORE, ORE_SMALL).mats(of(Chrsoberyl, 8, Alexandrite, 6, Cymophane, 3, Bertrandite, 10));
    public static Material BerylGroup = new Material(Ref.ID, "beryl_group", 0x50ff50, SHINY).asDust(ORE, ORE_SMALL).mats(of(BerylGroupA, 4, BerylGroupB, 4));
    public static Material SpinelGroup = new Material(Ref.ID, "spinel_group", 0x0b0f0b, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(WhiteSpinel, 5).put(BlackSpinel, 10).put(BalasAmeythest, 3).put(BalasEmerald, 3).put(BalasRuby, 5));
    public static Material JadeGroup = new Material(Ref.ID, "jade_group", 0x3af284, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(WhiteJade, 3).put(NephriteJade, 5).put(BlackJade, 4).put(GreenJade, 4).put(PurpleJade, 1));
    public static Material FlouriteGroupA = new Material(Ref.ID, "flourite_groupa", 0x0d0d0c, GEM_V).asGem(true, ORE, ORE_SMALL).mats(b -> b.put(BlackFlourite, 1).put(WhiteFlourite, 1).put(CyanFlourite, 1).put(YellowFlourite, 1).put(GreenFlourite, 1));
    public static Material FlouriteGroupB = new Material(Ref.ID, "flourite_groupb", 0x9e0b03, GEM_V).asGem(true, ORE, ORE_SMALL).mats(b -> b.put(RedFlourite, 1).put(BlueFlourite, 1).put(PurpleFlourite, 1).put(MagentaFlourite, 1).put(PinkFlourite, 1));
    public static Material FlouriteGroup = new Material(Ref.ID, "flourite_group", 0xf2f2f0, GEM_V).asGem(true, ORE, ORE_SMALL).mats(of(FlouriteGroupA, 6, FlouriteGroupB, 6));
    ...
    public static Material MagnesiumMineralsA = new Material(Ref.ID, "magnesium_minerals_a", 0xffc8c8, SHINY).asDust(ORE, ORE_SMALL).mats(of(Olivine, 6, Magnesite, 10, Magnesia, 1, Biotite, 3));
    public static Material MagnesiumMineralsB = new Material(Ref.ID, "magnesium_minerals_b", 0xffc8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Glauconite, 1).put(Bentonite, 1).put(Talc, 1).put(Soapstone, 1).put(MagnesiumChloride, 10));
    public static Material MagnesiumMineralsC = new Material(Ref.ID, "magnesium_minerals_c", 0xffc8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(SpinelGroup, 5).put(Rhodonite, 2).put(SnowFlakeObsidian, 2).put(Pyrope, 4));
    public static Material MagnesiumMinerals = new Material(Ref.ID, "magnesium_minerals", 0xffc8c8, SHINY).asDust(ORE, ORE_SMALL).mats(of(MagnesiumMineralsA, 20, MagnesiumMineralsB, 20, MagnesiumMineralsC, 10));
    ...
    public static Material ReactiveMetalsGroup = new Material(Ref.ID, "reactive_metals_group", 0xffc8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Alkali, 10).put(Alkaline, 8).put(RareEarths, 4).put(Metalloids, 3).put(Alumina, 20));
    public static Material MetalsGroup = new Material(Ref.ID, "metals_group", 0xc8c8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(PreciousMetalsGroup, 2).put(HeavyMetalsGroup, 4).put(ReactiveMetalsGroup, 3).put(IronMetalsGroup, 10).put(PrePlatinumTransition, 3));
    public static Material DiamondGroupA = new Material(Ref.ID, "diamond_group_a", 0xc8ffff, SHINY).asDust(ORE, ORE_SMALL).mats(of(Diamond, 10, YellowDiamond, 4, GrayDiamond, 3, BrownDiamond, 3));
    public static Material DiamondGroupB = new Material(Ref.ID, "diamond_group_b", 0xf7682f, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(GoldDiamond, 2).put(OrangeDiamond, 3).put(RedDiamond, 1).put(PinkDiamond, 1).put(MagentaDiamond, 1));
    public static Material DiamondGroupC = new Material(Ref.ID, "diamond_group_c", 0x21ffcf, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(LimeDiamond, 2).put(BlueDiamond, 2).put(PurpleDiamond, 1).put(PinkDiamond, 1).put(CyanDiamond, 2));
    public static Material DiamondGroup = new Material(Ref.ID, "diamond_group", 0xc8ffff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(DiamondGroupA, 20).put(DiamondGroupB, 10).put(DiamondGroupC, 3).put(Diamond, 5).put(MagnesiumMinerals, 2));
    public static Material LithiumSalts = new Material(Ref.ID, "lithium_salts", 0xe1dcff, SHINY).asDust(ORE, ORE_SMALL).addTools(9.0F, 590, 3).mats(b -> b.put(LithiumChlorate, 2).put(LithiumChloride, 2).put(LithiumHydroxide, 2).put(LithiumOxide, 2));
    public static Material LithiumMinerals = new Material(Ref.ID, "lithium_minerals", 0xe1dcff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Petalite, 4).put(Sugilite, 1).put(Tourmaline, 1).put(Tungstate, 2).put(Spodumene, 8));
    ...
    public static Material CalciumMineralsA = new Material(Ref.ID, "calcium_minerals_a", 0xfff5f5, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Tanzanite, 1).put(Scheelite, 1).put(Grossular, 1).put(Andradite, 1).put(Powelite, 1));
    public static Material CalciumMineralsB = new Material(Ref.ID, "calcium_minerals_b", 0xfff5f5, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Quicklime, 10).put(Bentonite, 4).put(Lazurite, 3).put(CalciumSulfite, 1).put(Phosphorus, 8));
    public static Material CalciumMineralsC = new Material(Ref.ID, "calcium_minerals_c", 0xfff5f5, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(FlouriteGroup, 12).put(Loparite, 3).put(Eudialyte, 2).put(Lautarite, 2).put(Datolite, 2));
    public static Material CalciumMinerals = new Material(Ref.ID, "calcium_minerals", 0xfff5f5, SHINY).asDust(ORE, ORE_SMALL).mats(of(CalciumMineralsA, 1, CalciumMineralsB, 8, CalciumMineralsC, 2));
    public static Material PotassiumMineralsA = new Material(Ref.ID, "potassium_mineralsa", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Fuchsite, 5).put(Amazonite, 8).put(Turquoise, 1).put(Sugilite, 1).put(Pyrochlore, 1));
    public static Material PotassiumMineralsB = new Material(Ref.ID, "potassium_mineralsb", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(RockSalt, 10).put(Potash, 10).put(PotassiumFeldspar, 10).put(Lepidolite, 5).put(Glauconite, 5));
    public static Material PotassiumMineralsC = new Material(Ref.ID, "potassium_mineralsc", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Carnotite, 1).put(PotassiumBromide, 2).put(PotassiumCarbonate, 1).put(Moonstone, 3).put(Ukanite, 2));
    public static Material PotassiumMineralsD = new Material(Ref.ID, "potassium_minerals_d", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(PotassiumHydroxide, 1).put(PotassiumBisulfate, 1).put(PotassiumPersulfate, 1).put(PotassiumSulfide, 1).put(PotassiumSulfate, 1));
    public static Material PotassiumMinerals = new Material(Ref.ID, "potassium_minerals", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(of(PotassiumMineralsA, 4, PotassiumMineralsB, 8, PotassiumMineralsC, 5, PotassiumMineralsD, 4));
    public static Material CobaltOresA = new Material(Ref.ID, "cobalt_ores_a", 0x5050fa, SHINY).asDust(ORE, ORE_SMALL).mats(of(Skutterudite, 3, Cattierite, 2, Glaucodot, 2, Penroseite, 2));
    public static Material CobaltOres = new Material(Ref.ID, "cobalt_ores", 0x5050fa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Cobaltite, 10).put(Villamaininite, 1).put(Glaucodot, 2).put(CobaltOresA, 2).put(Trogtalite, 2));
    ...
    public static Material ChromeOres = new Material(Ref.ID, "chrome_ores", 0xffe6e6, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Chromite, 10).put(Ruby, 1).put(Uvarovite, 1).put(Crocoite, 2).put(ChromeChalcedony, 2));
    public static Material TungstenOres = new Material(Ref.ID, "tungsten_ores", 0x323232, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(TungstenTrioxide, 3).put(Hubnerite, 4).put(Ferberite, 8).put(Tungsten, 1));
    public static Material ManganeseOresA = new Material(Ref.ID, "manganese_ores_a", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(of(Psilomelane, 2, Columbite, 2, Rhodochrosite, 2, Rhodonite, 1));
    public static Material ManganeseOresB = new Material(Ref.ID, "manganese_ores_b", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Tinaksite, 2).put(Kunzite, 2).put(Spessartine, 2).put(Tourmaline, 2).put(Sugilite, 2));
    public static Material ManganeseOresC = new Material(Ref.ID, "manganese_ores_c", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(ManganeseChloride, 2).put(Tantalite, 3).put(Pyrolusite, 8).put(Hauerite, 2).put(Hubnerite, 2));
    public static Material PlatinumGroupSludgeRaw = new Material(Ref.ID, "platinum_group_sludge_raw", 0xffffc8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Erlichmanite, 2).put(RuthOsmoxide, 2).put(IridiumOxide, 2).put(IridiumChloride, 2).put(Polarite, 4));
    public static Material CooperSperyliteGroup = new Material(Ref.ID, "cooper_sperylite_group", 0xffffc8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(PlatinumGroupSludge, 4).put(Cooperite, 8).put(Sperrylite, 16).put(Geversite, 4).put(Insizwaite, 4));
    public static Material ZirconiumGroup = new Material(Ref.ID, "zirconium_group", 0x4a0505, GEM_V).asGem(true, ORE, ORE_SMALL).mats(b -> b.put(Zircon, 10).put(WhiteZircon, 3).put(YellowZircon, 1).put(ZirconiumChloride, 2));
    public static Material BismuthGroup = new Material(Ref.ID, "bismuth_group", 0x64a0a0, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Insizwaite, 8).put(Polarite, 6).put(Bismuthinite, 6).put(Bismite, 8));
    public static Material RareEarthOres = new Material(Ref.ID, "rare_earth_ores", 0x324632, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(RareEarths, 5).put(Monazite, 5).put(Eudialyte, 3).put(Gadolinite, 3).put(Euxenite, 3));
    public static Material SilverOres = new Material(Ref.ID, "silver_ores", 0xdcdcff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Silver, 6).put(Arquerite, 6).put(SilverIodide, 2).put(Acanthite, 18).put(Argyrodite, 6));
    public static Material GoldOres = new Material(Ref.ID, "gold_ores", 0xffff1e, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Gold, 48).put(Calaverite, 2).put(Sylvanite, 2).put(Petzite, 1).put(Aurostibite, 1));
    public static Material TantalumOre = new Material(Ref.ID, "tantalum_ore", 0xffffff, SHINY).asDust(ORE, ORE_SMALL).mats(of(Tantalite, 30, Euxenite, 10, TantalumPentoxide, 8, Tantalum, 2));
    public static Material LeadOres = new Material(Ref.ID, "lead_ores", 0x8c648c, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Lead, 5).put(Galena, 10).put(Litharge, 2).put(Angelsite, 8).put(Vanadinite, 2));
    public static Material NickelOresA = new Material(Ref.ID, "nickel_ores_a", 0xc8c8fa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Nickel, 1).put(Taenite, 2).put(Nickeline, 2).put(Millerite, 10).put(Gersdorffite, 4));
    public static Material NickelOres = new Material(Ref.ID, "nickel_ores", 0x32c846, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Garnierite, 10).put(Pentlandite, 5).put(NickelOresA, 2).put(Penroseite, 3).put(Vaesite, 3));
    public static Material TitaniumOres = new Material(Ref.ID, "titanium_ores", 0xdca0f0, SHINY).asDust(ORE, ORE_SMALL).mats(of(Rutile, 10, Ilmenite, 4, Loparite, 2, Tinaksite, 2));
    ...
    public static Material LapisGroup = new Material(Ref.ID, "lapis_group", 0x4646dc, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Lapis, 6).put(Lazurite, 6).put(Sodalite, 6).put(SapphireGroupA, 4).put(Pyrite, 4));
    public static Material LabradoriteGroup = new Material(Ref.ID, "labradorite_group", 0xe6e070, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(YellowLabradorite, 3).put(GreenLabradorite, 3).put(BlueLabradorite, 3).put(OrangeLabradorite, 3).put(BlueTopaz, 3));
    public static Material SunstoneGroup = new Material(Ref.ID, "sunstone_group", 0x57ba7f, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Sunstone, 10).put(RedSunstone, 3).put(GreenSunstone, 2).put(VioletSunstone, 1).put(Topaz, 12));
    public static Material AluminiumOresA = new Material(Ref.ID, "aluminium_ores_a", 0x6464c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(GarnetRed, 3).put(GarnetYellow, 3).put(Alumina, 4).put(Bauxite, 40).put(Spodumene, 5));
    public static Material AluminiumOresB = new Material(Ref.ID, "aluminium_ores_b", 0xf7fcfc, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Amazonite, 3).put(Muscovite, 3).put(Fuchsite, 3).put(Turquoise, 3).put(Sugilite, 2));
    public static Material AluminiumOresC = new Material(Ref.ID, "aluminium_ores_c", 0x0b0f0b, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(SpinelGroup, 8).put(JadeGroup, 6).put(SunstoneGroup, 6).put(BerylGroup, 3).put(LabradoriteGroup, 3));
    public static Material AluminiumOresD = new Material(Ref.ID, "aluminium_ores_d", 0x8f8c33, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Epidote, 3).put(Kunzite, 3).put(Chrysocolla, 3).put(SodiumAluminate, 3).put(Cryolite, 3));
    public static Material AluminiumOresE = new Material(Ref.ID, "aluminium_ores_e", 0xffffc8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Rosenbergite, 2).put(Hercynite, 2).put(Petalite, 2).put(Rublicine, 2).put(Tanzanite, 2));
    public static Material AluminiumOres = new Material(Ref.ID, "aluminium_ores", 0x80c8f0, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(AluminiumOresA, 30).put(AluminiumOresB, 5).put(LapisGroup, 5).put(AluminiumOresC, 5).put(AluminiumOresD, 3));
    public static Material MolyOres = new Material(Ref.ID, "moly_ores", 0xb4b4dc, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Molybendite, 20).put(Wulfenite, 6).put(Drysdallite, 4).put(Molybdite, 4));
    ...
    public static Material SulfurOresFe = new Material(Ref.ID, "sulfur_ores_fe", 0x967828, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Sulfur, 20).put(Pyrite, 10).put(ArsenoPyrite, 2).put(Villamaininite, 2).put(Tetrahedrite, 10));
    public static Material SulfurOresCu = new Material(Ref.ID, "sulfur_ores_cu", 0xa07828, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Chalcopyrite, 10).put(Germanite, 5).put(Tennanite, 5).put(Digenite, 4).put(Bornite, 2));
    public static Material SulfurOresNiCo = new Material(Ref.ID, "sulfur_ores_ni_co", 0x5050fa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Millerite, 10).put(Pentlandite, 20).put(Cobaltite, 7).put(Gersdorffite, 4).put(Cattierite, 2));
    public static Material SulfurOresNa = new Material(Ref.ID, "sulfur_ores_na", 0x000096, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(SodiumBisulfate, 5).put(SodiumPyrosulfate, 5).put(SodiumSulfate, 5).put(SodiumSulfide, 5).put(SodiumSulfite, 5));
    public static Material SulfurOresCa = new Material(Ref.ID, "sulfur_ores_ca", 0xfff5f5, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Gypsum, 10).put(CalciumSulfate, 5).put(CalciumSulfite, 5).put(Barite, 5).put(Alkaline, 3));
    public static Material SulfurOresK = new Material(Ref.ID, "sulfur_ores_k", 0xfafafa, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(PotasiumPersulfate, 5).put(PotassiumBisulfate, 5).put(PotassiumSulfide, 5).put(PotassiumPyrosulfate, 5).put(Alkali, 3));
    public static Material SulfurOresPt = new Material(Ref.ID, "sulfur_ores_pt", 0xffffc8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Cooperite, 6).put(Laurite, 1).put(Cinnabar, 5).put(Erlichmanite, 1).put(Lorandite, 1));
    public static Material SulfurOresAgPbBi = new Material(Ref.ID, "sulfur_ores_ag_pb_bi", 0x643c64, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Galena, 10).put(Angelsite, 10).put(Acanthite, 10).put(Argyrodite, 10).put(Bismite, 3));
    public static Material SulfurOresTrans = new Material(Ref.ID, "sulfur_ores_trans", 0xffffff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Hauerite, 3).put(Patronite, 3).put(Stibinite, 5).put(Sphalerite, 5));
    public static Material SulfurOresPostTrans = new Material(Ref.ID, "sulfuroresposttrans", 0x91919, SHINY).asDust(ORE, ORE_SMALL).mats(of(Molybendite, 4, Greenocklite, 3, Gallite, 3, Roquesite, 2));
    public static Material SulfurGroup = new Material(Ref.ID, "sulfur_group", 0xc8c800, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(SulfurOresK, 5).put(SulfurOresPostTrans, 3).put(SulfurOresCa, 3).put(SulfurOresTrans, 3).put(Sulfur, 10));
    public static Material SulfurMegaGroup = new Material(Ref.ID, "sulfur_mega_group", 0xc8c800, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(SulfurOresFe, 16).put(SulfurOresCu, 12).put(SulfurOresNiCo, 8).put(SulfurOresAgPbBi, 4).put(SulfurOresPt, 2));
    public static Material RedStoneOres = new Material(Ref.ID, "redstone_ores", 0xc80000, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Redstone, 30).put(Pyrite, 10).put(Cinnabar, 5).put(ChromeOres, 3).put(Ruby, 2));
    public static Material CopperOxides = new Material(Ref.ID, "copper_oxides", 0x1782cf, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Malachite, 5).put(CupricOxide, 10).put(Azurite, 7).put(Turquoise, 2).put(Larimar, 1));
    public static Material CopperSelenAntim = new Material(Ref.ID, "copper_selen_antim", 0x464646, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Stibinite, 3).put(Tetrahedrite, 5).put(Krutaite, 2).put(Penroseite, 2).put(Eskebornite, 2));
    public static Material CopperOres = new Material(Ref.ID, "copper_ores", 0x2b373b, SHINY).asDust(ORE, ORE_SMALL).mats(of(SulfurOresCu, 2, CopperOxides, 2, CopperSelenAntim, 1, SulfurOresPostTrans, 1));
    public static Material ClayMinerals = new Material(Ref.ID, "clay_minerals", 0xc8c800, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Kaolinite, 12).put(Glauconite, 8).put(Garnierite, 6).put(BrownLimonite, 10).put(YellowLimonite, 10));
    ...
    public static Material SelenidesA = new Material(Ref.ID, "selenides_a", 0xe8e4e3, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Dzarkenite, 2).put(Trogtalite, 3).put(Clausthalite, 2).put(Eskebornite, 2).put(Ferroselite, 1));
    public static Material SelenidesB = new Material(Ref.ID, "selenides_b", 0x94948f, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Krutaite, 3).put(Penroseite, 3).put(Trogtalite, 3).put(Drysdallite, 2).put(Tiemannite, 1));
    public static Material Selenides = new Material(Ref.ID, "selenides", 0x57ba7f, SHINY).asDust(ORE, ORE_SMALL).mats(of(SelenidesA, 5, SelenidesB, 2));
    public static Material ArsenicOresA = new Material(Ref.ID, "arsenic_ores_a", 0xccd1cb, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Gersdorffite, 3).put(Nickeline, 6).put(Safflorite, 3).put(Tennanite, 4).put(Rammelsbergite, 3));
    public static Material ArsenicOresB = new Material(Ref.ID, "arsenic_ores_b", 0xbf1900, SHINY).asDust(ORE, ORE_SMALL).mats(of(Sperrylite, 4, Lorandite, 8, Realgar, 12, Arsenic, 3));
    public static Material ArsenicOres = new Material(Ref.ID, "arsenic_ores", 0xffffff, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Realgar, 12).put(ArsenicOresA, 15).put(ArsenicOresB, 15).put(ArsenoPyrite, 10).put(Glaucodot, 4));
    public static Material PhosphorOres = new Material(Ref.ID, "phosphor_ores", 0xffff00, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Xenotime, 2).put(Phosphor, 10).put(Phosphorus, 10).put(Apatite, 6).put(Phosphate, 10));
    public static Material IodineOres = new Material(Ref.ID, "iodine_ores", 0x140f05, SHINY).asDust(ORE, ORE_SMALL).mats(of(Iodine, 5, IodineSalt, 5, SilverIodide, 3, Lautarite, 4));
    ...
    public static Material IronClay = new Material(Ref.ID, "iron_clay", 0xc8c800, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(BrownLimonite, 12).put(YellowLimonite, 12).put(Glauconite, 8).put(Ferrosilite, 3).put(BandedIron, 4));
    public static Material IronGems = new Material(Ref.ID, "iron_gems", 0x96ff96, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Andradite, 4).put(Tanzanite, 3).put(Obsidian, 4).put(Olivine, 10).put(Amethyst, 5));
    public static Material IronOresA = new Material(Ref.ID, "iron_ores_b", 0xc8c8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Siderite, 4).put(Bornite, 4).put(Chalcocite, 4).put(Ferrite, 4).put(Ferberite, 4));
    public static Material IronOresB = new Material(Ref.ID, "iron_ores_c", 0xc8c8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Epidote, 4).put(FerricChloride, 6).put(FerrousChloride, 5).put(Hercynite, 4));
    public static Material IronOresC = new Material(Ref.ID, "iron_ores_a", 0xc8c8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(FerriteMixture, 1).put(Tetrahedrite, 5).put(TigerIron, 2).put(Rhodonite, 2).put(IronOresB, 10));
    public static Material IronOres = new Material(Ref.ID, "iron_ores", 0xc8c8c8, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(MagnetBan, 15).put(IronClay, 15).put(IronGems, 5).put(SulfurOresFe, 4).put(JadeGroup, 5));
    ...
    public static Material QuartzGroupA = new Material(Ref.ID, "quartz_group_a", 0xe6d2d2, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Amethyst, 4).put(Citrine, 2).put(CertusQuartz, 3).put(Reibeckite, 3).put(Onyx, 4));
    public static Material QuartzGroupB = new Material(Ref.ID, "quartz_group_b", 0xe6d2d2, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(RedJasper, 5).put(GreenJasper, 5).put(YellowJasper, 5).put(BlackJasper, 5).put(BrownJasper, 5));
    public static Material QuartzGroupC = new Material(Ref.ID, "quartz_group_c", 0xe6d2d2, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(TigerIron, 2).put(TigersEye, 5).put(MossAgate, 5).put(Agate, 5).put(Chrysoprase, 5));
    public static Material QuartzGroupD = new Material(Ref.ID, "quartz_group_d", 0xe6d2d2, SHINY).asDust(ORE, ORE_SMALL).mats(of(ChromeChalcedony, 4, Chalcedony, 2, Olivine, 4, Moissanite, 3));
    public static Material QuartzGroup = new Material(Ref.ID, "quartz_group", 0xe6d2d2, SHINY).asDust(ORE, ORE_SMALL).mats(of(Quartz, 20, QuartzGroupA, 5, QuartzGroupB, 5, QuartzGroupC, 5, QuartzGroupD, 5));
    ...
    public static Material MercuryGroup = new Material(Ref.ID, "mercury_group", 0x960000, SHINY).asDust(ORE, ORE_SMALL).mats(b -> b.put(Terlinguaite, 4).put(Cinnabar, 20).put(Arquerite, 8).put(Tiemannite, 6).put(Livingstonite, 5));
