package constantinefradius.gim.utils;
...
public class EnumHelper
{
    ...
    public static boolean isIsObfuscated() {
        return isObfuscated;
    }

    public static void setIsObfuscated(boolean isObfuscated) {
        EnumHelper.isObfuscated = isObfuscated;
    }
    ...
    public static <T extends Enum<? >> T addEnum(Class<T> enumType, String enumName, Class<?>[] paramTypes, Object[] paramValues)
    {
        ...
        int flags = (isIsObfuscated() ? Modifier.PUBLIC : Modifier.PRIVATE) | Modifier.STATIC | Modifier.FINAL | 0x1000 /*SYNTHETIC*/;
        if (valuesField == null)
        {
        ...
        if (valuesField == null)
        {
            System.out.println("Could not find $VALUES field for enum: " + enumType.getName());
            System.out.println("Runtime Deobf: "+ isIsObfuscated());
            System.out.println("Flags: "+ String.format("%16s", Integer.toBinaryString(flags)).replace(' ', '0'));
            System.out.println("Fields:");
            for (Field field : fields)
            {
                String mods = String.format("%16s", Integer.toBinaryString(field.getModifiers())).replace(' ', '0');
                System.out.println("       "+mods+" "+field.getName()+": "+field.getType().getName());
            }
            return null;
        }
